...
//    private final Cache<BaseTagCacheKey, Object> tagCache;
    ...
    public EvaluationContext(Template self, boolean strictVariables, Locale locale,
            ...
            ExecutorService executorService, List<Template> importedTemplates, ScopeChain scopeChain,
            Hierarchy hierarchy) {
...
//        this.tagCache = tagCache;
    ...
    public EvaluationContext shallowCopyWithoutInheritanceChain(Template self) {
        EvaluationContext result = new EvaluationContext(self, strictVariables, locale, extensionRegistry, executorService, importedTemplates, scopeChain, null);
        return result;
    }
    ...
    public EvaluationContext threadSafeCopy(Template self) {
        EvaluationContext result = new EvaluationContext(self, strictVariables, locale, extensionRegistry, executorService, new ArrayList<>(importedTemplates), scopeChain.deepCopy(), hierarchy);
        return result;
    }
     ...
     */
    public List<Template> getImportedTemplates() {
